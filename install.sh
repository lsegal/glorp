...
npx --yes skills add "$repo@gh-fix" --global --agent codex --agent claude-code --agent cline -y </dev/null
npx --yes skills add "$repo@gh-discuss" --global --agent codex --agent claude-code --agent cline -y </dev/null
